$(document).ready(function() {
  $("form#survey").submit(function(event){
    ...
    var favorites1 = [music, color, food, dessert, animal]; //gathers each form input value and places them into one array.

    var favorites2 = favorites1.slice(0,2); //music, color
    var favorites3 = favorites2.reverse(); //color, music
